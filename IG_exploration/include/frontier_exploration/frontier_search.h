...
public:
     ...
     */
    std::list<Frontier> searchFrom(geometry_msgs::Point position , unsigned int& index , visualization_msgs::MarkerArray& markerArray); //wlf add
...
protected:
     ...
     * @return
     */
    Frontier buildNewFrontier(unsigned int initial_cell, unsigned int reference, std::vector<bool>& frontier_flag , visualization_msgs::Marker& circle);
